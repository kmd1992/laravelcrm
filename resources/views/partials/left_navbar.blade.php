    ...
    <div class="ks-wrapper ks-sidebar-wrapper">
        <ul class="nav nav-pills nav-stacked">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item ks-active" href="index-2.html">Default</a>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="index-2.html">Default</a>
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle"  href="#" role="button" aria-haspopup="true" aria-expanded="false">
                            <span>Sidebar</span>
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="http://themesanytime.com/kosmo/demo/admin/sidebar_sections-primary/index.html" target="_blank">Sections</a>
                            <a class="dropdown-item" href="http://themesanytime.com/kosmo/demo/admin/sidebar_compact-primary/index.html" target="_blank">Compact</a>
                            <a class="dropdown-item" href="http://themesanytime.com/kosmo/demo/admin/sidebar_iconbar-primary/index.html" target="_blank">Iconbar</a>
                            <a class="dropdown-item" href="http://themesanytime.com/kosmo/demo/admin/sidebar_iconbar_compact-primary/index.html" target="_blank">Iconbar Compact</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle"  href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="http://themesanytime.com/kosmo/demo/admin/horizontal_navbar-primary/index.html" target="_blank">Horizontal</a>
                            <a class="dropdown-item" href="http://themesanytime.com/kosmo/demo/admin/horizontal_navbar_iconbar-primary/index.html" target="_blank">Horizontal Iconbar</a>
                        </div>
                    </div>
                </div>
            </li>
